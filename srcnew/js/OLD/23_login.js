(function () {
	...
	loginctrl.$inject = ['$window','$scope', '$rootScope','$http', 'cssInjector','$interval',
    '$timeout','$localStorage','$resource','toastr']

    function loginctrl($window,$scope, $rootScope, $http ,cssInjector, $interval, $timeout,$localStorage, $resource, toastr ) {
