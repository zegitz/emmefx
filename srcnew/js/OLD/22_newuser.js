(function () {
  ...
  .controller('newuserctrl', newuserctrl)
    newuserctrl.$inject = ['$window','$scope', '$rootScope', '$http','$localStorage', 'cssInjector','$interval',
    '$timeout','$resource','toastr']

    function newuserctrl($window,$scope, $rootScope, $http,$localStorage ,cssInjector, $interval, $timeout, $resource, toastr ) {
