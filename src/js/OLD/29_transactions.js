(function () {
  ...
  .controller('transactionsctrl', transactionsctrl);
    ...
    transactionsctrl.$inject =  ['$window','$scope', '$rootScope', '$http', 'cssInjector','$interval',
    '$timeout']

    function transactionsctrl ($window,$scope, $rootScope, $http , cssInjector, $interval, $timeout) {
