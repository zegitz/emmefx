(function () {
  ...
  .controller('edituserctrl', edituserctrl)
    edituserctrl.$inject = ['$window','$scope', '$rootScope', '$state', '$http','$localStorage', 'cssInjector','$interval',
    '$timeout','$resource','toastr']

    function edituserctrl($window,$scope, $rootScope, $state ,$http,$localStorage ,cssInjector, $interval, $timeout, $resource, toastr ) {
