(function () {
  ...
  .controller('vpsctrl', vpsctrl)
    vpsctrl.$inject = ['$window','$scope', '$rootScope', '$http','$localStorage','$interval',
    '$timeout','$resource', 'toastr']

    function vpsctrl($window,$scope, $rootScope, $http ,$localStorage , $interval, $timeout, $resource, toastr ) {
