(function () {
  ...
  .controller('monitorVpsCtrl', monitorVpsCtrl)
    monitorVpsCtrl.$inject = ['$window','$scope','$location', 'datatable','$rootScope', '$http','$localStorage','$interval',
    '$timeout']

    function monitorVpsCtrl($window,$scope ,$location , datatable, $rootScope, $http ,$localStorage  , $interval, $timeout) {
