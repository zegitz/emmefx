(function () {
  ...
  .controller('monitorFundsCtrl', monitorFundsCtrl)
    monitorFundsCtrl.$inject = ['$window','$scope','$location', 'datatable','$rootScope', '$http','$localStorage','$interval',
    '$timeout']

    function monitorFundsCtrl($window,$scope ,$location , datatable, $rootScope, $http ,$localStorage  , $interval, $timeout) {
