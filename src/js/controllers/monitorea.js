(function () {
  ...
  .controller('monitorEaCtrl', monitorEaCtrl)
    monitorEaCtrl.$inject = ['$window','$scope','$location', 'datatable','$rootScope', '$http','$localStorage','$interval',
    '$timeout']

    function monitorEaCtrl($window,$scope ,$location , datatable, $rootScope, $http ,$localStorage  , $interval, $timeout) {
